    ...
    <div class="container px-4 px-lg-5 h-100  justify-content-around align-content-center">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row col-md-12">
                ...
                <div class="form-floating mb-3  col-md-4">
                    <input class="form-control" id="inputTitle" name="text" type="text" placeholder="Some Text" />
                    <label for="inputPassword">Type in keyword</label>
                </div>
        ...
        <div class="col-md-12 d-flex flex-column justify-content-around align-items-center vh-100 w-100">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (
                    ...
                    $stmt = "select * from posts where post like %'$text' or date(publish) =$publish";
